...
def main(sub_name_dicts, eval_params, intermediate=False, model_dir=None,
    ...
    for sub in range(len(sub_name_dicts)):
        ...
        if intermediate:
            ...
            preds_axial = truenet_tumseg_data_postprocessing.get_final_testdata_3dvolumes(np.argmax(probs_axial, axis=3), test_sub_dict)
            if verbose:
        ...
        if intermediate:
            ...
            preds_sagittal = truenet_tumseg_data_postprocessing.get_final_testdata_3dvolumes(np.argmax(probs_sagittal, axis=3), test_sub_dict)
            if verbose:
        ...
        if intermediate:
            ...
            preds_coronal = truenet_tumseg_data_postprocessing.get_final_testdata_3dvolumes(np.argmax(probs_coronal, axis=3), test_sub_dict)
            if verbose:
        ...
        if postproc is False:
            ...
            probs_tc = truenet_tumseg_data_postprocessing.resize_testdata_to_original_size(probs_tc, test_sub_dict,
                                                                                  plane='tc')
            preds_tc = truenet_tumseg_data_postprocessing.get_final_testdata_3dvolumes(np.argmax(probs_tc, axis=3), test_sub_dict)
